// Archivo: routes/salePaymentRoutes.js (Versión Completa y Corregida)
...
const initSalePaymentRoutes = (models, sequelize) => {
    ...
    // Ruta optimizada para obtener la lista de ventas
    ...
    // Ruta para exportar a Excel (colocada antes de las rutas dinámicas)
    ...
    // Ruta para las cobranzas del gestor
    ...
    // Ruta optimizada para crear una venta
    router.post('/', authorizeRoles(['super_admin', 'regular_admin', 'sales_admin']), async (req, res) => {
        // ... (código optimizado de la respuesta anterior)
    });

    // Ruta para asignar un gestor
